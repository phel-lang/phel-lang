...
- `src/phel/core.phel` split into topic files under `src/phel/core/` (sequences, atoms, fns-sets, math, io, protocols, lazy, exceptions, macroexpand, parsing, uuid, loops), loaded via `(load ...)`
