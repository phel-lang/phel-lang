...
- An uncaught runtime error reads the same from `phel run`, `phel eval` and the REPL: message, `at` line, user-visible frames, one collapsed marker, and a hint when one matches. (#3264)
