...
final class PersistentSortedSetTest extends TestCase
{
    ...
    /**
     * A set carrying NaN stays equal to *itself*: the element walk compares NaN
     * against NaN (never `=`), so the `$this === $other` identity short-circuit
     * is what keeps equality reflexive.
     */
