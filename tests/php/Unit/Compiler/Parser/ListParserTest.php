...
';
        ...
        $this->expectExceptionMessageIsOrContains("Unterminated list starting at line 2. Did you forget a closing ')'?");
    ...
    public function test_unterminated_vector_error_throws_unfinished_exception(): void
    {
        ...
        $this->expectException(UnfinishedParserException::class);
        $this->expectExceptionMessageIsOrContains("Unterminated vector starting at line 1. Did you forget a closing ']'?");
